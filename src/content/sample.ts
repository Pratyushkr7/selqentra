...
export const sample: Rec[] = [
  {
    ...
    product: 'Exact grade match', evidence: 'Strong · 4 sources agree', confidence: 0.91, risk: '—', action: 'Accept. Request batch COA naming the site.',
    trail: [
  ...
  },
  {
    ...
    product: 'Product family only', evidence: 'Clear · role contradicted', confidence: 0.86, risk: 'Role misrepresented', action: 'Reclassify as trader. Do not RFQ as a producer.',
    trail: [
  ...
  },
  {
    ...
    product: 'Exact grade match', evidence: 'Mixed · production unverified', confidence: 0.52, risk: 'Plant unverified', action: 'Needs review. Request plant address and certificate number.',
    trail: [
  ...
  },
  {
    ...
    product: 'Exact grade match', evidence: 'Strong · principal named', confidence: 0.88, risk: '—', action: 'Accept as channel. Record the principal it represents.',
    trail: [
  ...
  },
  {
    ...
    product: 'No match found', evidence: 'None retrievable', confidence: 0.12, risk: 'Source inaccessible', action: 'Remove or re-source. Nothing supports this record.',
    trail: [
...
export const filters = [
  ...
  { id: 'verified', label: 'Verified', test: (r: Rec) => r.status === 'verified' },
  { id: 'review', label: 'Needs review', test: (r: Rec) => r.status === 'review' },
  { id: 'unsupported', label: 'Unsupported', test: (r: Rec) => r.status === 'unsupported' },
  { id: 'mfg', label: 'Manufacturer', test: (r: Rec) => r.verified === 'Manufacturer' },
  { id: 'td', label: 'Trader / distributor', test: (r: Rec) => r.verified === 'Trader' || r.verified === 'Distributor' },
] as const;
